import LoginInput from "@/src/app/components/input/logininput"
import Link from "next/link"

export default function Login(){
    return(
        <main className="justify-self-center">
            <section className="lg:w-1/2 m-70 min-h-screen">
                <div className="flex flex-col items-center gap-3">
                    <i className="bi bi-person-circle text-blue-400 text-9xl"></i>
